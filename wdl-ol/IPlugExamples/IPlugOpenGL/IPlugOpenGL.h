...
//      kCGLPFADepthSize, (CGLPixelFormatAttribute)16,
  ...
  bool Draw(IGraphics* pGraphics)
  {
    ...
    mRotateTri+=1.5f*xxx/300.f;											// Increase The Rotation Variable For The Triangle ( NEW )
    mRotateQuad-=1.65f*xxx/300.f;										// Decrease The Rotation Variable For The Quad ( NEW )
